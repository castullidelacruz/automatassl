...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_input_line = 13,                /* input_line  */
...
static const char *const yytname[] =
{
  ...
  "'+'", "'-'", "'*'", "'/'", "'('", "')'", "$accept", "input",
  "input_line", "expr", "term", "factor", YY_NULLPTR
};
...
{
       0,    11,     0,     0,     2,     0,     7,    10,     0,     1,
       3,     4,     0,     0,     0,     0,    12,     5,     6,     8,
       9
};
...
{
       9,     1,    10,     1,    14,    15,     0,     2,     0,     2,
      12,    13,    11,    12,    13,    16,    17,    18,     8,     0,
      19,    20
};
...
#line 32 "analizadorsintactico.y"
        ...
        if (!validar_rango((yyvsp[-1].valor))) {
